      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            onClick={onClose}
          >
            {/* Unfolding Paper Sheet Container */}
            <motion.div
              initial={{ scale: 0.05, rotate: -25, opacity: 0, borderRadius: "200px" }}
              animate={{
                scale: 1,
                rotate: 0,
                opacity: 1,
              ...
              style={{
                ...
                height: "90vh",
                maxHeight: "900px",
                backgroundColor: "#FBF9F5", // Real paper texture cream base
                color: "#1C1B19", // Contrast charcoal paper text
                boxShadow: "0 25px 60px rgba(0,0,0,0.35)",
                display: "flex",
                flexDirection: "column",
                position: "relative",
                // Apply the SVG displacement filter when uncrumpling is active
            ...
            >
              ...
              <div
                style={{
                  ...
                  alignItems: "center",
                  padding: "20px 32px",
                  borderBottom: "1px dashed #E4E1DB",
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    <span>·</span>
                    <a href="https://linkedin.com/in/megh17" target="_blank" rel="noopener noreferrer" style={{ color: "inherit", textDecoration: "none", borderBottom: "1px solid #D1CDC4" }}>
                      linkedin.com/in/megh17
                    </a>
                    <span>·</span>
                    <a href="https://github.com/megh17" target="_blank" rel="noopener noreferrer" style={{ color: "inherit", textDecoration: "none", borderBottom: "1px solid #D1CDC4" }}>
                      github.com/megh17
                    </a>
                  </div>
                </div>

                <div style={{ height: "1px", backgroundColor: "#E4E1DB" }} />
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                    <div>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "8px", marginBottom: "4px" }}>
                        <h3 style={{ fontSize: "16px", fontWeight: 700, margin: 0, color: "#1C1B19" }}>
                          Full Stack Developer Intern
                        </h3>
                        <span style={{ fontFamily: "var(--font-mono)", fontSize: "11px", color: "#8B8476" }}>
                          Dec 2025 – Apr 2026
                        </span>
                      </div>
                      ...
                      <ul style={{ paddingLeft: "16px", margin: 0, display: "flex", flexDirection: "column", gap: "6px", fontSize: "14px", color: "#4E483E", lineHeight: 1.5 }}>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "14px", color: "#6B6559", margin: "0 0 8px 0" }}>
